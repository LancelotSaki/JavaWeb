...
<title>主页面功能</title>
	...
	<link rel="stylesheet" href="login_style/css/reset.css"/>
	<link rel="stylesheet" href="login_style/css/global.css"/>
	<link rel="stylesheet" href="login_style/css/component.css"/>
	<link rel="stylesheet" href="login_style/css/login.css"/>
	<script src="login_style/js/jquery-1.8.2.min.js"></script>
	<script src="login_style/js/jquery.cookie.js"></script>
	<script src="login_style/js/jquery.validate.js"></script>
	<script src="login_style/js/jquery.metadata.js"></script>
	<script src="login_style/js/jquery.validate.message_cn.js"></script>
	<script src="login_style/js/jquery.nicescroll.min.js"></script>
	<script src="login_style/js/mgTextWidth.js"></script>
	<script src="login_style/js/tinybox.js"></script>
    <script src="login_style/js/global.js"></script>
	<script src="login_style/js/components.js"></script>
	<script src="login_style/js/md5.js"></script>
	<script src="login_style/js/login.js"></script>
	<script>
		...
		<div class="login_form">
			...
			<div class="login_coopeField">
				...
				<div class="coopeLogin_mainFiild">
					...
					<a class="btn_coopeLogin coopeLogin_mingdao" href="http://www.jq-school.com/"><span class="span_coopeLogin">用明道账户登录</span></a>
